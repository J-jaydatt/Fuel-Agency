...
public class CustomerController {
    ...
    public String registerCustomer(@ModelAttribute("customer") @Valid CustomerDTO customerDTO,BindingResult bindingResult,Model model,RedirectAttributes redirectAttributes) {
        System.out.println("Register cutomer ,,,,,,,,,,,,,,,,,,,,"+customerDTO);
    	if (bindingResult.hasErrors()) {
    		System.out.println("Error part cutomer ,,,,,,,,,,,,,,,,,,,,"+customerDTO);
